...
gulp.task("copy_readme", function() {
  return gulp.src(folder.src + "*.md").pipe(gulp.dest(folder.build));
});

gulp.task("static", function() {
  return gulp
    .src(folder.src + "static/**/*")
...
gulp.task("js", function() {
  var jsbuild = gulp.src(folder.src + "js/**/*").pipe(deporder());
